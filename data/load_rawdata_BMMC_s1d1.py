...
RNA_data = anndata.read_h5ad(os.path.join(dataset_dir, 'rna.h5ad'))
ATAC_data = anndata.read_h5ad(os.path.join(dataset_dir, 'atac.h5ad'))
...
if 'cell_type' in RNA_data.obs.columns:
    ...
    raise ValueError(
        "No 'cell_type' in obs. Cannot generate 'clusters' without it. Please check data or run clustering algorithm.")
