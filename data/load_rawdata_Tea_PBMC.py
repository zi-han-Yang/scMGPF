...
dataset_dir = "E:/data/raw_data/Tea_PBMC"
RNA_data = anndata.read_h5ad(os.path.join(dataset_dir, 'RNA/test_RNA.h5ad'))
ATAC_data = anndata.read_h5ad(os.path.join(dataset_dir, 'ATAC/test_ATAC.h5ad'))
