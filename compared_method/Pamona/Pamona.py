...
class Pamona(object):
    ...
    def __init__(self, n_shared=None, M=None, n_neighbors=10, epsilon=0.001, Lambda=1.0, virtual_cells=1,
                 output_dim=32, max_iter=1000, tol=1e-9, manual_seed=666, mode="distance", metric="minkowski",
                 verbose=True):
    ...
    def alignment_score(self, data1_shared, data2_shared, data1_specific=None, data2_specific=None):
        alignment_sco = test_alignment_score(data1_shared, data2_shared, data1_specific=data1_specific,
                                             data2_specific=data2_specific)
