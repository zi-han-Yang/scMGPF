...
source_aligned = run_scTopoGAN(source_latent, target_latent, source_tech_name="ATAC", target_tech_name="RNA",
                               batch_size=512, topology_batch_size=1000, total_epochs=1501, num_iterations=20,
...
inte = [target_latent.to_numpy(), source_aligned.to_numpy()]
...
np.save(os.path.join(result_dir, 'scTopoGAN.npy'), scTopoGAN_inte)
